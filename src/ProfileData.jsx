const profiles = [
    ...
    hobbies: [
      {
        title: "Poetry",
        description:
          "Writes and recites Hindi and Urdu verses during open mic nights",
      },
      {
        title: "Badminton",
      ...
      },
      {
        title: "Spirituality",
        description:
          "Practices meditation and reads spiritual literature regularly",
      },
      {
        title: "Long Walks",
  ...
  },
  {
    ...
    description:
      "Sneha is rooted in values, loves connecting with people and believes in lifelong learning.",
    hobbies: [
      {
        title: "Volunteering",
  ...
  },
  {
    ...
    description:
      "An introverted extrovert who enjoys deep conversations, nature and slow living.",
    hobbies: [
      {
        title: "Road Trips",
      ...
      },
      {
        title: "Filter Coffee",
        description:
          "A self-proclaimed connoisseur who brews her own every morning",
      },
      {
        title: "Board Games",
